...
export function Calendar({
  ...
  const allDisabledDays = [...disabledDays, ...(disableUnavailable ? unavailableDays : [])];
          ...
          return (
            <button
              ...
              className={cn(
                "h-full w-full rounded-full hover:bg-accent focus:bg-accent focus:outline-none transition-colors",
                isUnavail &&
                  "bg-destructive/10 text-destructive border border-destructive/20 cursor-not-allowed opacity-60",
